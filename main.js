/*Attempt to use Parallax.js*/
      ...
      $(document).ready(function(){
        ...
        $(".tulip").on('click touch', function(){
          ...
          //if tulip is clicked when the first scene is true
          //$(".text01").removeClass("hide");
